...
O PNG-base do D6 permanece byte a byte igual ao arquivo original. A v0.6.0 aplica apenas `transform: scale(.9)` em CSS para corrigir a percepção de tamanho e equilibrá-lo visualmente com D4, D8, D10, D12 e D20. A mesma regra é usada nas superfícies do ecossistema.
